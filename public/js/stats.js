...
var accel  = multiplexer.channel('accelerometer');
...
accel.onmessage = function(e) {
  ...
  $("#accelerometerPayload").html("accel<br> {x: " + value.x + ", y: " + value.y + ", z: " + value.z + "}");
  sensorData.setReading("accelerometer", value);
};

var gyro  = multiplexer.channel('gyroscope');
...
gyro.onmessage = function(e) {
  ...
  value.y = parseFloat(value.y);
  value.z = parseFloat(value.z);
  $("#gyroscopePayload").html("gyro<br> {x: " + value.x + ", y: " + value.y + ", z: " + value.z + "}");
  sensorData.setReading("gyroscope", value);
};

var mag  = multiplexer.channel('magnetometer');
mag.onopen = function() {
...
mag.onmessage = function(e) {
  ...
  value.y = parseFloat(value.y);
  value.z = parseFloat(value.z);
  $("#magnetometerPayload").html("mag<br> {x: " + value.x + ", y: " + value.y + ", z: " + value.z + "}");
  sensorData.setReading("magnetometer", value);
};

var temperature  = multiplexer.channel('temperature');
temperature.onopen = function() {
  console.log("temperature open");
};
